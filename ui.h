...
void render_midi_ctrl(WiFiClient client) {
  String tpl =
      F("<div>DEBUG <a href='/debug_cc'>CC</a>&nbsp;<a "
        ...
        "<h5>NETWORK: {{midiname}} {{localip}}:{{midiport}}</h5>"
...
void render_cc_ctrl(EEPROMStorage<uint16_t> smin, EEPROMStorage<uint16_t> smax,
                    ...
                    WiFiClient client) {
  String tpl = F("<form method='post' action='/cc'><fieldset>"
                 "<div class='float-right'><input type='submit' "
...
void render_note_ctrl(int id, uint16_t trig_min, uint16_t trig_max,
  ...
  String tpl = F("<form method='post' action='/note{{uid}}'><fieldset>"
                 "<div class='float-right'><input type='submit' "
...
void render_near_note_ctrl(uint16_t trig, uint16_t note, WiFiClient client) {
  String tpl = F("<form method='post' action='/near_note'><fieldset>"
                 "<div class='float-right'><input type='submit' "
...
void render_far_note_ctrl(uint16_t trig, uint16_t note, WiFiClient client) {
  String tpl = F("<form method='post' action='/far_note'><fieldset>"
                 "<div class='float-right'><input type='submit' "
...
void render_page(WiFiClient client) {
  String tpl = F(
      ...
      //.2rem;padding:.2rem
      //.5rem;white-space:nowrap}pre{background:#f4f5f6;border-left:0.3rem solid
      ...
      //.column.column-offset-90{margin-left:90%}.row .column.column-10{flex:0 0
      // 10%;max-width:10%}.row .column.column-20{flex:0 0
      // 20%;max-width:20%}.row .column.column-25{flex:0 0
      // 25%;max-width:25%}.row .column.column-33,.row .column.column-34{flex:0
      // 0 33.3333%;max-width:33.3333%}.row .column.column-40{flex:0 0
      // 40%;max-width:40%}.row .column.column-50{flex:0 0
      // 50%;max-width:50%}.row .column.column-60{flex:0 0
      // 60%;max-width:60%}.row .column.column-66,.row .column.column-67{flex:0
