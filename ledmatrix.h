...
// 100 frames maximum. Compute as maximum length of text you want to print (eg.
// 20 chars) multiplied by font width (eg. 5 for Font_5x7), so 20 chars * 5 px =
// 100. If you enter lower value (or your text get unexpectedly long), animation
// will be cut and end soon.
...
void set_matrix_text(String text) { matrix_text = text; }
...
void leds_error() {
    unsigned long frame[] = {
        0xF010820,   // bits 0–31
        0x42F42F42,  // bits 32–63
        0x41080F0    // bits 64–95
    };
